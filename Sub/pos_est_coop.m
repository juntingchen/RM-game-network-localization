function p_hat_g1 = pos_est_coop(Xne1, p_hat, J0_cell, Dist_ms2ms, Xi_ms2ms, Phi_ms2ms, ...
                      Xi_ms2bs, Z_bs, Pos_bs)
%
...
for i_ms = 1:Nms 
    ...
    if norm(Lambda_c) > 0
        ls_func = @(x) ls_coop(x, Xi_ms2bs(i_ms, :), Z_bs(i_ms, :), ...
                               Pos_bs, Lambda_c, Z_c, Pos_hat);
